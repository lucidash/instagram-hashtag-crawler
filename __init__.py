...
if __name__ == '__main__':
    ...
    config = {
        ...
        'max_collect_media' : 10000,                # how many media items to be collected per person/hashtag. If time is specified, this is ignored
        'min_timestamp' : int(time() - 60*60*18)         # up to how recent you want the posts to be in seconds. If you do not want to use this, put None as value
        # 'min_timestamp' : None
    }
